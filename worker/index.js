// WhisperLink - WebRTC Signaling + Static Serve
// Cloudflare Worker

const SIGNAL_URL = 'https://whisper-link-signal.hmsathayrt1.workers.dev';
...
export default {
  async fetch(request, env, ctx) {
    ...
    // Serve HTML for root or /index.html
  ...
  <script>
    ...
    function startPolling() {
      pollingInterval = setInterval(async () => {
        try {
          const resp = await fetch('/api/signal?roomId=' + roomId + '&peerId=' + peerId);
